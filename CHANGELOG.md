...
- The area, line and composed charts draw their gridlines through one `grid_svg` builder instead of three identical template blocks; every visual baseline still matches.
