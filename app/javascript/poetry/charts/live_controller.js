...
// The live channel (Phase B-W3): a chart rendered with live: true carries
...
// new, the Phase A morph); a structure change (window growth, series
// change) snaps instead - recharts' own update behavior. The tooltip's
...
export default class ChartLiveController extends Controller {
  ...
  #render(payload, { animate = true } = {}) {
    ...
    if (!jobs) {
      // Structure changed (window growth, gaps appearing) - snap, the
      // recharts update behavior for added/removed data.
      this.#settle()
      return
    }
